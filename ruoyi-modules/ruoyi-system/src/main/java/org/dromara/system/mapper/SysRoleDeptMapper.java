...
// 系统领域实体类：角色与部门关联实体
// SysRoleDept是系统角色与部门关联实体类，对应数据库的sys_role_dept表，存储角色和部门的关联关系
import org.dromara.system.domain.SysRoleDept;

/**
 * 角色与部门关联表 数据层
 * 继承BaseMapperPlus，提供角色与部门关联表的CRUD操作
 * 使用BaseMapperPlus提供的增强方法，简化数据访问层开发
 * 主要负责角色和部门关联关系的增删改查操作，用于数据权限控制
 *
 * @author Lion Li
 */
// 继承BaseMapperPlus，泛型参数：SysRoleDept表示实体类型，第二个SysRoleDept表示视图对象类型（与实体相同）
