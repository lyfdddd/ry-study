...
// 系统领域实体类：文件上传实体
// SysOss是系统文件上传实体类，对应数据库的sys_oss表，存储文件上传记录信息
import org.dromara.system.domain.SysOss;
// 系统视图对象：文件上传视图对象
// SysOssVo是文件上传的视图对象，用于返回给前端的文件信息
import org.dromara.system.domain.vo.SysOssVo;

/**
 * 文件上传 数据层
 * 继承BaseMapperPlus，提供文件上传表的CRUD操作和VO转换能力
 * 使用BaseMapperPlus提供的增强方法，简化数据访问层开发
 * 主要负责文件上传记录的增删改查操作，用于文件管理
 *
 * @author Lion Li
 */
// 继承BaseMapperPlus，泛型参数：SysOss表示实体类型，SysOssVo表示视图对象类型
