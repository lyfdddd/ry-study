...
// 系统领域实体类：参数配置实体
// SysConfig是系统参数配置实体类，对应数据库的sys_config表
import org.dromara.system.domain.SysConfig;
// 系统视图对象：参数配置视图对象
// SysConfigVo是参数配置的视图对象，用于返回给前端的配置信息
import org.dromara.system.domain.vo.SysConfigVo;

/**
 * 参数配置 数据层
 * 继承BaseMapperPlus，提供参数配置表的CRUD操作和VO转换能力
 * 使用BaseMapperPlus提供的增强方法，简化数据访问层开发
 *
 * @author Lion Li
 */
// 继承BaseMapperPlus，泛型参数：SysConfig表示实体类型，SysConfigVo表示视图对象类型
