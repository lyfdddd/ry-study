...
// 系统领域实体类：登录日志实体
// SysLogininfor是系统登录日志实体类，对应数据库的sys_logininfor表，存储用户登录日志信息
import org.dromara.system.domain.SysLogininfor;
// 系统视图对象：登录日志视图对象
// SysLogininforVo是登录日志的视图对象，用于返回给前端的登录日志信息
import org.dromara.system.domain.vo.SysLogininforVo;

/**
 * 系统访问日志情况信息 数据层
 * 继承BaseMapperPlus，提供登录日志表的CRUD操作和VO转换能力
 * 使用BaseMapperPlus提供的增强方法，简化数据访问层开发
 * 主要负责用户登录日志的增删改查操作，用于审计和安全分析
 *
 * @author Lion Li
 */
// 继承BaseMapperPlus，泛型参数：SysLogininfor表示实体类型，SysLogininforVo表示视图对象类型
