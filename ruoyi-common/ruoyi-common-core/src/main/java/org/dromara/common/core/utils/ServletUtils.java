...
import jakarta.servlet.ServletRequest; // 通用请求接口
import jakarta.servlet.http.HttpServletRequest; // HTTP请求接口
import jakarta.servlet.http.HttpServletResponse; // HTTP响应接口
import jakarta.servlet.http.HttpSession; // HTTP会话接口
...
public class ServletUtils extends JakartaServletUtil {
     ...
     *
     * @param str 原始字符串
     * @return URL编码后的字符串（如"中文" -> "%E4%B8%AD%E6%96%87"）
     */
     ...
     * @return 解码后的原始字符串（如"%E4%B8%AD%E6%96%87" -> "中文"）
     */
